 ...
 *     of Contexts.
 * <li><b>Context</b> - Representation of a single ServletContext(代表一个web程序),
 *      which will
 *     typically contain one or more Wrappers for the supported servlets.
 * <li><b>Wrapper(多实例的Servlet)</b> - Representation of an individual servlet definition
 ...
 *     for this Container into the JVM in which Catalina is running.(类加载器)
 ...
 *     this Container.（Session管理）
 * <li><b>Realm</b> - Read-only interface to a security domain, for
 *     authenticating user identities and their corresponding roles.(认证)
 * <li><b>Resources</b> - JNDI directory context enabling access to static
 *     resources, enabling custom linkages to existing server components when
 *     Catalina is embedded in a larger server.（JNDI，也不用了， 老技术 ！！！！！！！！！！！！！！）
 * </ul>
 *
 * @author Craig R. McClanahan
 * @author Remy Maucherat
 * <p>
 * Engine, Host , Context 都可以看成是一个容器，容器也就具有生命周期的特性，所以继承Lifecycle是合理的
 */
